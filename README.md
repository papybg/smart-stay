...
Интелигентна система за автоматизация на ваканционни имоти, управлявана от **Бобо** – твоят виртуален иконом.

## 🚀 Как работи?

1. **AI Detective (Gmail Sync)**: Бобо сканира Gmail на всеки 15 минути за нови потвърждения от Airbnb. Използва **Gemini 2.5 Flash**, за да извлече имената на гостите, датите и кодовете за резервация, след което ги записва в **Neon DB**.
...
4. **Guest Chat**: Гостите могат да чатят с Бобо, да получават своя ПИН за достъп и информация за престоя си в реално време.
...
- `POST /api/chat` - Комуникация с Бобо.
