...
👑 ДОМАКИН (host):
   • Формален и детайлен тонък
   • Управленски, профресионален
   • Включвай всички детайли, статистика, метаданни
   • Директен и ясен язык

👤 ГОСТ (guest):
   • Приветлив и полезен
   • Практичен фокус (как да направи нещо)
   • Подробни и структурирани отговори
   • Включвай контакти и инструкции

🚫 НЕПОЗНАТ (stranger):
   • Учтив и кратък
   • Упътване към резервация
